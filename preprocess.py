...
def resize(stackPath, largerSize, newDir):
    ...
    if not resized :
        ...
        for fileName in os.listdir(stackPath) :
            ...
            if not os.path.isdir(filePath) and (fileName.endswith('.jpg') or  fileName.endswith('.png')):
                ...
                print" WARNING " +str(filePath) + " does not exist or is not a png/jpg image !!"
        ...
        for stacks in dirs :
            ...
            if not cur_stack.endswith('_flipped'):
                ...
                for img in os.listdir(cur_stack) :
                    ...
                    if not os.path.isdir(imgPath) and img.endswith('.png') or img.endswith('.jpg') :
